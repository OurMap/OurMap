...
////////////////////////////////////////////////////////////////////////////////
// ATTENTION: This copy of the Treeview script has been purchased from        //
// GubuSoft/ Conor O'Mahony by The Banff Centre under a Distributor's License,//
// See complete license details                                               //
// at: http://www.treeview.net/tv/license_dist.asp                            //
//                                                                            //
// This file has been modified from its original version.                     //
// -Oct 11 2010: Changed the behaviour by using the tag "span" instead of "a" //
// See the list of lines modified at the bottom of this file.                 //
////////////////////////////////////////////////////////////////////////////////
...
{ 
  ...
  if (browserVersion > 0) 
    auxEv = "<span onclick='javascript:clickOnNode(\""+this.getID()+"\")'>"
  else 
    auxEv = "<span>"
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
	    leftSide = leftSide + "<td valign=top>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></span></td>"
    else 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></span></td>"
...
{ 
  ...
  { 
	if (USEFRAMES)
	  docW = docW + "<span onclick='" + this.hreference + "' TARGET=\"basefrm\" "
	else
	  docW = docW + "<span onclick='" + this.hreference + "' TARGET=_top "
...
{ 
  ...
  docW = docW + "<tr>" + leftSide + "<td valign=top>"
  if (USEICONS)
      docW = docW + "<span " + fullLink  + " id=\"itemIconLink"+this.id+"\">" + "<img id='itemIcon"+this.id+"' " + "src='"+this.iconSrc+"' border=0>" + "</span>"
  else
	  if (this.prependHTML == "")
  ...
  if (USETEXTLINKS) 
    docW = docW + "<span " + fullLink + " id=\"itemTextLink"+this.id+"\">" + this.desc + "</span>"
  else 
    docW = docW + this.desc
...
{ 
 ...
 /**
  *
  * This copy of the Treeview script has been purchased from
  * GubuSoft/ Conor O'Mahony by The Banff Centre under a Distributor’s License,
  * it has been modified on lines:

149
    auxEv = "<a href='javascript:clickOnNode(\""+this.getID()+"\")'>"
with:
    auxEv = "<span onclick='javascript:clickOnNode(\""+this.getID()+"\")'>"
By Manuel C Cuesta, Oct 11, 2010
